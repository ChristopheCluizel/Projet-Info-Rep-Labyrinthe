...
import javabyrinthe.labyrinthe._

object GenerateurLabyrinthe {

    def sauvegarderLabyrinthe(labyrinthe: Labyrinthe, cheminFichier: String) = {
    ...
    def chargerGraphe(cheminFichier: String): Graph[Int] = {
    ...
    def genererLabyrinthe(largeur: Int, hauteur: Int): Labyrinthe = {
        ...
        return new Labyrinthe(graphe, positionArrivee, positionDepart)
    }
